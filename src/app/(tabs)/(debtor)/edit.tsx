...
export default function EditDebtorScreen() {
  ...
  useEffect(() => {
    if (debtor) {
      setFirstName(debtor.firstName);
      setLastName(debtor.lastName);
      setPhone(debtor.phone);
      setWorkPlace(debtor.workPlace);
      setGender(debtor.gender as "m" | "f");
    }
  }, [debtor]);
  ...
  return (
    ...
    >
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.headerInfo}>
          <View style={styles.iconCircle}>
            <Ionicons name="pencil" size={32} color="#4F46E5" />
          </View>
          <Text style={styles.headerSubtitle}>Update the debtor's details below.</Text>
        </View>
      ...
      <View style={styles.footer}>
        ...
        >
          <Text style={styles.saveButtonText}>Update Debtor</Text>
        </TouchableOpacity>
      </View>
    </KeyboardAvoidingView>
  );
