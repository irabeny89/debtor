		...
		<View style={styles.container}>
				...
				<View style={styles.mainCard}>
					...
					<View style={styles.mainCardContent}>
						<View style={styles.mainCardHeader}>
							...
							<Text style={styles.mainCardLabel}>Total Debtors</Text>
						</View>
						<Text style={styles.mainCardValue}>{total}</Text>
					</View>
				</View>
			</View>
			...
			<View style={styles.gridContainer}>
				...
				<View style={styles.gridItem}>
					...
					<Text style={styles.gridValue}>{inActive}</Text>
					<Text style={styles.gridLabel}>Inactive</Text>
				</View>
				...
				<View style={styles.gridItem}>
					...
					<Text style={styles.gridValue}>{suspended}</Text>
